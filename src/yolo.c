...
char *voc_names[] = {"001","002"};
image voc_labels[NUM_CLASS];

void train_yolo(char *cfgfile, char *weightfile)
{
    char *train_images = "/home/snowneji/Downloads/DarkNet_data/train.txt";
    char *backup_directory = "/home/snowneji/Downloads/DarkNet_data/backup/";
    srand(time(0));
